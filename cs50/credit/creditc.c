...
//printf("First two digits are: %c%c \n", str[0], str[1]);
...
//int size_for_count = sizeof(card) / sizeof(card[0]);// int i,j;
// for (j = 0; j < size_for_count; j++ )
//    {
//    printf("[%i] = %i; ", j, card[j] );
//    }
// printf("\n");

// for(i = 0; i < size_for_count; ++i)
//     {
//     printf("%i", card[i]);
//     }
// printf("\n");
